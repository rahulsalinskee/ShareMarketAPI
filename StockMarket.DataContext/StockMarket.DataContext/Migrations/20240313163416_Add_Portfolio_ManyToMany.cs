...
{
    /// <inheritdoc />
    public partial class Add_Portfolio_ManyToMany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TblComments_TblStocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblPortfolio", x => new { x.UserId, x.StockId });
                    table.ForeignKey(
                        name: "FK_TblPortfolio_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TblPortfolio_TblStocks_StockId",
                        column: x => x.StockId,
                        principalTable: "TblStocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TblComments_StockId",
                table: "TblComments",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_TblPortfolio_StockId",
                table: "TblPortfolio",
                column: "StockId");
        }
